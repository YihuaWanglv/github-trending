...
- [jmdhappy/xxpay](http://git.oschina.net/jmdhappy/xxpay-master) : XxPay聚合支付使用Java开发，分为srping-cloud和dubbo分布式架构版本，已接入微信、支付宝等主流支付渠道，可直接用于生产环境。
...
- [comingundone/springmvc_demo](http://git.oschina.net/comingundone/springmvc_demo) : 
- [合一科技/youba-vue-web](http://git.oschina.net/inoneone/youba-vue-web) : 
- [hament/vue2.0_basic](http://git.oschina.net/hament/vue2.0_basic) : vue 2.0基础学习
- [JackieYip/模板podspec](http://git.oschina.net/JackieYip/MoBanPodspec) : 
...
- [louchen/九洲社区居民客户端](http://git.oschina.net/hycj/hycj_jiuzhou_app) : 
- [龙鹏/CHGJ](http://git.oschina.net/ThirDragon/CHGJ) : 创恒国际
- [JackieYip/FTResource](http://git.oschina.net/JackieYip/FTResource) : 
- [jzman/blog](http://git.oschina.net/jzmanu/blog) : 使用Hexo搭建个人博客，记录学习生活...
- [JackieYip/FTSizeByMeasure](http://git.oschina.net/JackieYip/FTSizeByMeasure) : 
- [路灯/MCore静态文件模块](http://git.oschina.net/ludeng/manage_static) : 
- [路灯/MCore后台管理模块](http://git.oschina.net/ludeng/mcore_manage) : 
- [yaowk/basecode](http://git.oschina.net/yaowk/basecode) : 
- [JackieYip/FTMacro_Tab](http://git.oschina.net/JackieYip/FTMacro_Tab) : 
- [JackieYip/FTMacro_Screen](http://git.oschina.net/JackieYip/FTMacro_Screen) : 
- [JackieYip/FTMacro_AppDelegate](http://git.oschina.net/JackieYip/FTMacro_AppDelegate) : 
- [南望孤笑/taotao](http://git.oschina.net/vhucong/taotao) : 
- [JackieYip/FTLibraries_FoundationValidation](http://git.oschina.net/JackieYip/FTLibraries_FoundationValidation) : 
- [JackieYip/FTMediator](http://git.oschina.net/JackieYip/FTMediator) : 
- [JackieYip/FTBundle_Macro](http://git.oschina.net/JackieYip/FTBundle_Macro) : 
- [谢小舜/turntable](http://git.oschina.net/jsung/turntable) : 一个大转盘的项目
- [JackieYip/FTDebug_Macro](http://git.oschina.net/JackieYip/FTDebug_Macro) : 