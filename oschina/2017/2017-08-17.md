...
- [大弹簧/Alpaca-Spa-Laravel后台管理系统-前后分离](http://git.oschina.net/cc-sponge/Alpaca-Spa-Laravel) : Alpaca-Spa-Laravel 是用Alpaca-Spa + Laravel 前后端分离开发的一款后台管理系统的DEMO. 主要功能模块有登录、定时任务管理、用户管理、权限管理、个人信息管理等。在实际开发中可以根据具体的需求添加新的功能。 开发模式为前后分离开发，Alpaca-Spa负责实现前端功能，包括组织页面结构，渲染页面数据、样式，交互逻辑等，Laravel负责提供后台功能，访问数据库，处理业务逻辑，提供数据接口给前端，
...
- [zhoumq/vue-element](http://git.oschina.net/zhoumq/vue-element) : vue2.0 , element
- [啾啾川/jiujiuchuan](http://git.oschina.net/JiuJiuChuan/jiujiuchuan) : 
- [bboss/genproject](http://git.oschina.net/bboss/genproject) : this project is a tool that be used to gen a java project base bboss public devlop platform.gencode site:http://gencode.bbossgroups.com
- [494060889@qq.com/cloud](http://git.oschina.net/dubbox/cloud) : spring cloud
- [个人项目/待办事项](http://git.oschina.net/pesonal/TodoList-Html) : 暂时做纯静态页的待办事项
- [Colorado/jianshu](http://git.oschina.net/Colorado/jianshu) : laravel5.4开发的文章社区网站
...
- [食人魔魔法师/ktgg](http://git.oschina.net/null_419_2402/ktgg) : 
- [风残雪/html_meteor](http://git.oschina.net/ydxwei/html_meteor) : 前端框架
...
- [MuziLi/MuziLiEclipseCore](http://git.oschina.net/lxgzj/MuziLiEclipseCore) : MuziLi插件核心
- [yangq/qcmanage](http://git.oschina.net/yangq/qcmanage) : 
- [oschina6k/EducationManage](http://git.oschina.net/oschina6k/educationmanage) : 教学管理
- [Max/amc-c](http://git.oschina.net/leeshing0315/amc-c) : AMC System
- [lyq_sg/Super App](http://git.oschina.net/lyq_sg/Super-App) : 超级app
- [chatroom/Main](http://git.oschina.net/chatroom/Main) : 聊天室。
