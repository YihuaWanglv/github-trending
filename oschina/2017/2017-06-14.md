...
- [goroutine/tidb](http://git.oschina.net/ngaut/tidb) : TiDB is a distributed SQL database. Inspired by the design of Google F1, TiDB supports the best features of both traditional RDBMS and NoSQL.
...
- [许雪里/xxl-mq](http://git.oschina.net/xuxueli0323/xxl-mq) : 分布式消息队列XXL-MQ
...
- [icecooly/FastHttpClient](http://git.oschina.net/icecooly/FastHttpClient) : 封装OkHttp(https://github.com/icecooly/FastHttpClient)
- [Mirrors/xmlweb](http://git.oschina.net/mirrors/xmlweb) : 
- [ALEX-小鱼/vue-phone-model](http://git.oschina.net/liupan520/vue-phone-model) : A vue mobile phone model component
- [tongbing/zghyi](http://git.oschina.net/mnbd/zghyi) : 
- [Class8/homework](http://git.oschina.net/class8/homework) : 作业仓库
...
- [Mirrors/react-ui-builder](http://git.oschina.net/mirrors/react-ui-builder) : 
- [icecooly/POIUtils](http://git.oschina.net/icecooly/poiutils) : Excel文件快速读取和写入数据
- [Buynow_Zhao/chat-server](http://git.oschina.net/Buynow96/chat-server) : 基于Netty开发 聊天室
- [zhaojh329/lede](http://git.oschina.net/zhaojh329/lede) : Mirror of https://git.lede-project.org/?p=source.git Please send your PRs against this tree. They will be merged via staging trees and appear in this tree once the staging trees get merged back into source.git
- [Mirrors/flubber](http://git.oschina.net/mirrors/flubber) : 
- [yuerzm/crowdThink](http://git.oschina.net/yuerzm/crowdthink) : 
- [FeanLau/b2ocre](http://git.oschina.net/feanlau/b2ocre) : 
- [烟波/mp3-server](http://git.oschina.net/macro/mp3-server) : PLC中MP3解析器
...
- [imxplus/imx-webrick](http://git.oschina.net/imxplus/imx-webrick) : 
- [slacrey/ddmovie](http://git.oschina.net/slacrey/ddmovie) : 
- [你若安好，便是晴天/CreditAssist](http://git.oschina.net/jinyixin/creditassist) : 
...
- [fredshao/MassiveGridMapForUnity3D](http://git.oschina.net/fredshao/massivegridmapforunity3d) : Unity3D massive grid map editor and manager
- [OubaYeung/blog](http://git.oschina.net/oubaYeung/blog) : 
- [花纹/zhaoshifu](http://git.oschina.net/laiwh/zhaoshifu) : 找师傅