...
- [iweans/PyVIP-09-M](http://git.oschina.net/iweans/PyVIP-09-M) : 潭州教育PythonVIP-09级-进阶班课件
...
- [Micooz/DesignPattern](http://git.oschina.net/micooz/DesignPattern) : 23种设计模式的C++实现
...
- [Jack Zhang/sewise-player](http://git.oschina.net/jackzhang1204/sewise-player) : Sewise Player是一款专业的免费网页HTML5视频、流播放器，它功能强大，体积小，跨平台，兼容性好，使用方便简洁、随心所欲。
...
- [yangyun.yy/exercise](http://git.oschina.net/yangyunyy/exercise) : 平时练习的代码，方便管理记录
- [Element/SinaweiBo](http://git.oschina.net/txt_123/SinaweiBo) : practice
- [whutddk/pmsm](http://git.oschina.net/whutddk/pmsm) : 毕业设计
- [BESTI.IS.Java2017/zjy20155312](http://git.oschina.net/bestiisjava2017/zjy20155312) : week2
- [建辉/stm32-mdk5](http://git.oschina.net/jianhuizhao/stm32-mdk5) : 
- [sedate_ocean/PPP](http://git.oschina.net/sedate_ocean/PPP) : 
- [SharkSeven/pg](http://git.oschina.net/sharkseven/pg) : 
- [celusi/Tongcheng](http://git.oschina.net/celusi/Tongcheng) : 同城约友
- [knight/knbbs](http://git.oschina.net/knightchim/knbbs) : knbbs
- [frankhan/img2htmloutput](http://git.oschina.net/frankhan/img2htmloutput) : test img2html, created by xlzd: https://github.com/xlzd/img2html
- [小而强大/Two](http://git.oschina.net/scphbin/Two) : 
- [onlygx/UDPTest](http://git.oschina.net/onlygx/UDPTest) : android udp室内机通讯
- [anker/anker1](http://git.oschina.net/anker_lu/anker1) : 线下发布环境
- [swb0866/sskj-dingtalk-server](http://git.oschina.net/swb0866/sskj-dingtalk-server) : 钉钉后台
- [Kevin/BomberMan](http://git.oschina.net/Kevin_HYS/BomberMan) : 
- [sanfusu/TEX](http://git.oschina.net/sanfusu/TEX) : PL std translation or the manual written by myself。
- [coolwhm/portal](http://git.oschina.net/coolwhm/portal) : spring+springmvc+mybatis 门户权限系统
- [夜猫子/WeiBo](http://git.oschina.net/yemaozi/WeiBo) : Swift编写微博APP
- [warm2016/WMWeibo](http://git.oschina.net/warm2016/WMWeibo) : swift练习微博项目
- [qhboy/anyhelper_sms](http://git.oschina.net/58661828/anyhelper_sms) : 数据库
- [六月/quicksilver](http://git.oschina.net/liuyueyi/quicksilver) : 开发过程中的小工具集合
- [遇松/tzg-risk-management4](http://git.oschina.net/wuanrin/tzg-risk-management4) : 
- [luofl/FFmpeg](http://git.oschina.net/luofl/FFmpeg) : mirror of git://source.ffmpeg.org/ffmpeg.git
- [Princerin/Urho3D](http://git.oschina.net/princrin/Urho3D) : 