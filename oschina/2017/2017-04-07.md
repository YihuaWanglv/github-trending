...
- [lennon/apache-james](http://git.oschina.net/lennonchan/apache-james) : 
...
- [项立/gm_app](http://git.oschina.net/.xl/gm_app) : 社交app
- [leewell/论坛demo](http://git.oschina.net/leewell/luntandemo) : 知乎论坛demo，接入聚云后台
- [PHP+NET+JAVA/BulletUI2017](http://git.oschina.net/MackCode/BulletUI2017) : BulletUI2017
- [wudi/filemule](http://git.oschina.net/netjoin/filemule) : 
- [lianyin2015/CIM](http://git.oschina.net/lianyin2015/CIM) : 分期管理系统
- [TouchAfflatus/myworld](http://git.oschina.net/TouchAfflatus/myworld) : unity3d实现的一个我的世界游戏;
- [dou361/kanhu](http://git.oschina.net/dou361/kanhu) : 网络视频分类相关的项目
- [yansxi/RecyclerView增删改查](http://git.oschina.net/diewu0421/recyclerviewzengshangaicha) : RecyclerView增删改查
- [钦寸水库管理/Reservoir](http://git.oschina.net/reservoir/Reservoir) : 
- [独钓寒江翎/myGame](http://git.oschina.net/reincarnation/mygame) : 
- [muercy/spring-dataflow-mesos](http://git.oschina.net/zhuantayigeyi/spring-dataflow-mesos) : 
- [小可先森/archapr](http://git.oschina.net/imxieke/archapr) : Arch Linux Person Repository imxieke
- [Dzlua/SuperDuilib](http://git.oschina.net/dzlua/SuperDuilib) : 
- [狂风123/studio-main](http://git.oschina.net/xgyin/studio-main) : 打游戏
- [walterzyw/walterblog](http://git.oschina.net/walterzone/walterblog) : 
- [Yiyuery/capsule-web](http://git.oschina.net/xiacy/capsule-web) : web components DIY
- [invoker/blog](http://git.oschina.net/zxh1986123/blog) : 
- [Mr.Chen./wz](http://git.oschina.net/Mr_ChenLuYong/wz) : ZNY & CLY
- [zhangjiangnan/commonUtil](http://git.oschina.net/dajiangnan/commonUtil) : jiangnan's common util
- [makerbob/tw](http://git.oschina.net/makerbob/tw) : tw repo
- [七宗罪/ProStudy](http://git.oschina.net/nzsghdx/ProStudy) : 
- [sparkshe/zz_server_newest](http://git.oschina.net/sparkshe/zz_server_newest) : 
- [我执/zendblog.cn](http://git.oschina.net/my_zend/zendblog) : zendblog 博客
- [farboy/shoufuyou](http://git.oschina.net/farboy/shoufuyou) : 首付游系统致力于为旅游、商旅等行业的商户提供信用消费解决方案，商户可以通过接入首付游SDK的方式来使用首付游提供的各种服务，这里主要从技术层面来描述接入首付游SDK的方式和交互细节。
