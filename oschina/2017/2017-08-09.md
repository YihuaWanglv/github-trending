...
- [baomidou/kisso-spring-boot](http://git.oschina.net/baomidou/kisso-spring-boot) : kisso SpringBoot 演示 demo
- [talent-tan/t-io](http://git.oschina.net/tywo45/t-io) : t-io是基于jdk aio实现的易学易用、稳定耐操、性能强悍、将多线程运用到极致、内置功能丰富、核心代码只有3000多行(2017年05月13号统计)的即时通讯框架(广义上的即时通讯，并非指im)，字母 t 寓意talent。
- [Looly/hutool](http://git.oschina.net/loolly/hutool) : 一个Java基础工具类，对文件、流、加密解密、转码、正则、线程、XML等JDK方法进行封装，组成各种Util工具类，同时提供以下组件： 1. 布隆过滤 2. 缓存 3. 数据库ORM（基于ActiveRecord思想）4. HTTP客户端 5. IO 6. JSON 7. 日志 8. System（JVM和系统信息等） 9. Setting（一种扩展Properties的配置文件）
- [LongRise/Android_Teaching_Materials](http://git.oschina.net/longrise/Android_Teaching_Materials) : 永兴元Android移动开发框架讲义
- [靳晓松/MJUI](http://git.oschina.net/ssstudio/MJUI) : 基于JQuery的适用于传统企业的WebUI，MJUI项目始于2014年，主要用于企业内部封闭式网络，且对浏览器有一定要求，做了很多兼容性、平衡性功能。该框架经历了很多真实项目的考验，组件满足大部分功能需求。
- [扶竹技术/ng2-fuzhutech-blog](http://git.oschina.net/fuzhutech/ng2-fuzhutech-blog) : 个人开发的博客，前端ng2-fuzhutech-blog采用angualr2 + ng2-Bootstrap实现，后端fuzhutech-blog基于Spring+SpringMVC+Mybatis架构.
...
- [hfkh-S102/Test](http://git.oschina.net/S102/Test) : 
...
- [Zoker/Taskover](http://git.oschina.net/kesin/taskover) : Taskover 是一款开源个人任务管理工具，通过简单易用的任务归纳分类方式，用来帮助您高效的追踪管理各项任务，最大化的提升工作效率。
- [扶竹技术/ng2-fuzhutech-blog](http://git.oschina.net/fuzhutech/ng2-fuzhutech-blog) : 个人开发的博客，前端ng2-fuzhutech-blog采用angualr2 + ng2-Bootstrap实现，后端fuzhutech-blog基于Spring+SpringMVC+Mybatis架构.
- [朋也/ITNews-React-Native](http://git.oschina.net/tomoya/ITNews-React-Native) : IT资讯APP，使用React Native编写
- [lancegin/QBox](http://git.oschina.net/lancegin/QBox) : 便携的七牛管理工具 GitHub地址：
...
- [Asililand/pos5ible](http://git.oschina.net/null_737_0283/pos5ible) : simple forum project!
- [jerry_shang/netbarpayment](http://git.oschina.net/creditsys/netbarpayment) : 这是支付平台
- [惜帅/govpover](http://git.oschina.net/xishuai392/govpover) : 
- [又双叒叕/bubble](http://git.oschina.net/runjp/bubble) : 
- [Mayuyu/Mayuyu](http://git.oschina.net/WatanabeMayu/Mayuyu) : 
- [andre/study](http://git.oschina.net/andreSSJ/study) : 学习项目
- [Sylar/mmwiki](http://git.oschina.net/kolo/mmwiki) : 私人项目不公开
- [apple/Tiger](http://git.oschina.net/applepingguo/Tiger) : Tiger
- [xiaodi1043/test](http://git.oschina.net/xiaodi1043/test) : 
- [代码人生/iblog-mobile](http://git.oschina.net/hdsl/iblog-mobile) : 林帅帅博客系统（移动版）
- [一沙粒一乾坤/201707](http://git.oschina.net/xixiandhaha/201707) : 不停的更新，不停的测试，会加上详细的注释
- [雨夜/学习-MyBatis](http://git.oschina.net/xxmi/study-mybatis) : 
- [koomox/yunwei](http://git.oschina.net/koomox/yunwei) : 日常运维中遇到的问题和解决方案。
- [青黄直落/es_phalcon](http://git.oschina.net/dirklu/es_phalcon) : 基于phalcon的es操作api
...
- [Summer/bos1.0](http://git.oschina.net/kuqikuqi/bos1.0) : 独立写的项目
- [比较叼的/huahuhualanApp](http://git.oschina.net/TC301/huahuhualanapp) : 
- [Z/my-admin](http://git.oschina.net/jh_zheng/my-admin) : 一个后台管理系统
- [ping222s/mLStartPorj](http://git.oschina.net/ping222s/mLStartPorj) : 
- [大侠等等我/mland](http://git.oschina.net/mland/mland) : Jekyll博客